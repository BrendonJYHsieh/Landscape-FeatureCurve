...
//============================================================================
{
	int r = rand() % 30 +10;
	points.clear();
	points.push_back(ControlPoint(Pnt3f(  0,100,0)));
	points.push_back(ControlPoint(Pnt3f( 10,100,10)));
	points.push_back(ControlPoint(Pnt3f( 20,100,20)));
	points.push_back(ControlPoint(Pnt3f( 30,100,30)));
